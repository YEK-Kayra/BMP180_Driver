 ...
 *      Author: TAISAT MARM-99
  ...
  *					**Will be added a few variable in function header to set I2C Communication, OverSamplingSetting
  *					**Will be added Kalman Filter or other filter for to get more reliable datas
  *
  ******************************************************************************
  */
